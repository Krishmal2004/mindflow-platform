...
export default function MainQuestionnaire() {
    ...
    if (loading) return <div className="flex h-screen items-center justify-center bg-slate-50"><Loader2 className="animate-spin h-8 w-8 text-neutral-400" /></div>;

    if (status?.status === 'completed') {
        return (
            <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
                <Card className="w-full max-w-md text-center p-8 space-y-6 animate-in zoom-in-95 duration-500 shadow-xl border-neutral-200">
                        ...
                        <div className="p-6 space-y-6 bg-white">
                            <div className="space-y-4">
                                <h3 className="font-semibold text-slate-900 flex items-center">
                                    <HelpCircle className="h-4 w-4 mr-2 text-neutral-600" />
                                    What to expect
                                </h3>
                                ...
                                {questionnaire.sections.map((section: Section, idx: number) => (
                                    <div key={idx} className="flex items-start gap-4 p-3 rounded-lg hover:bg-slate-50 transition-colors">
                                        <div className="h-8 w-8 rounded-full bg-neutral-100 flex items-center justify-center text-neutral-700 font-bold shrink-0 text-sm">
                                            {section.section_key}
                                        </div>
                                        <div>
        ...
        <div className="min-h-screen bg-slate-50 pb-28">
            ...
            <div className="max-w-2xl mx-auto p-4 space-y-8 mt-4 animate-in fade-in duration-500">
                ...
                <div className="space-y-2 text-center md:text-left">
                    ...
                    <p className="text-slate-600 leading-relaxed text-sm md:text-base border-l-4 border-neutral-900 pl-4 bg-neutral-50/50 py-2 rounded-r-lg">
                                ...
                                {q.question_type === 'likert' && (
                                    <div className="space-y-3">
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <div className={cn(
                                                            ...
                                                            isSelected
                                                                ? "border-neutral-900 bg-neutral-900 text-white shadow-neutral-200 transform scale-105"
                                                                : "border-slate-200 bg-white text-slate-600 group-hover:border-neutral-300 group-hover:bg-slate-50"
                                                        )}>
                                                            {val}
                                                        </div>
                                        ...
                                        <div className="md:hidden text-center h-4">
                                            {answers[q.id] && (
                                                <span className="text-xs font-medium text-neutral-600 animate-in fade-in">
