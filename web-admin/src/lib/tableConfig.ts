...
export const TABLES_CONFIG: TableConfig[] = [
    ...
    },
    {
        ...
        tableColumns: ['user_id', 'stress_level', 'calm_before', 'sleep_quality', 'calm_after', 'mindfulness_practice', 'created_at'],
        fields: [
            { name: 'user_id', label: 'User', type: 'text', required: true },
            { name: 'stress_level', label: 'Stress (1-5)', type: 'number', required: true },
            { name: 'calm_before', label: 'Calm Before (1-5)', type: 'number', required: true },
            { name: 'sleep_quality', label: 'Sleep Quality (1-5)', type: 'number', required: true },
            { name: 'calm_after', label: 'Calm After (1-5)', type: 'number', required: true },
            ...
            {
                name: 'practice_location', label: 'Practice Location', type: 'select', hideInTable: true,
                options: [{ label: 'At University', value: 'At University' }, { label: 'Outside University', value: 'Outside University' }],
            },
