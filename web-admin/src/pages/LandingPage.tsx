            ...
            <div className="w-full md:w-1/2 flex flex-col">
                ...
                <main className="flex-1 flex flex-col items-center justify-center p-8 text-center md:text-left md:items-start max-w-xl mx-auto md:mx-0 md:ml-20">
                    ...
                    <div className="mt-16 grid grid-cols-2 gap-8 text-left">
                        <div>
                            <h3 className="font-bold text-2xl text-neutral-900">2.4k+</h3>
                            <p className="text-sm text-neutral-400 mt-1">Active Participants</p>
                        </div>
                        <div>
                            <h3 className="font-bold text-2xl text-neutral-900">100%</h3>
                            <p className="text-sm text-neutral-400 mt-1">Secure & Private</p>
                        </div>
                    </div>
                </main>
            </div>
