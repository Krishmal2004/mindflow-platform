...
import { Loader2, Download, Users, Activity, Mic } from "lucide-react"
...
export default function AdminDashboard() {
    ...
    if (loading) return <div className="flex h-screen items-center justify-center"><Loader2 className="h-8 w-8 animate-spin text-neutral-400" /></div>;
            ...
            <div className="border-b border-neutral-200 bg-white">
                <div className="flex h-16 items-center px-4 max-w-7xl mx-auto justify-between">
                    <div className="flex items-center font-bold text-xl text-neutral-900">
                        <div className="h-8 w-8 bg-neutral-900 rounded-lg mr-2"></div>
                        MindFlow Admin
                    </div>
            ...
            <div className="flex-1 space-y-4 p-8 pt-6 max-w-7xl mx-auto w-full">
                <div className="flex items-center justify-between space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                        <Button onClick={() => alert("Downloading Report...")} variant="outline" className="border-neutral-200 text-neutral-700 hover:bg-neutral-50">
                ...
                <Tabs defaultValue="overview" className="space-y-4">
                    ...
                    <TabsContent value="overview" className="space-y-4">
                        ...
                        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <Card className="border border-neutral-200">
                                ...
                                <CardContent>
                                    ...
                                    <p className="text-xs text-neutral-500">Check-ins submitted</p>
                                </CardContent>
                            </Card>
                            <Card className="border border-neutral-200">
                                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                ...
                                <CardContent>
                                    ...
                                    <p className="text-xs text-neutral-500">Recordings stored</p>
                                </CardContent>
                            </Card>
                            <Card className="border border-neutral-200">
                                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        ...
                        <div className="grid gap-4 md:grid-cols-7">
                            <Card className="col-span-4 border border-neutral-200">
                                <CardHeader>
                                    ...
                                    <div className="h-[350px]">
                                        <ResponsiveContainer width="100%" height="100%">
                                            <LineChart data={chartData}>
                                                ...
                                                <Tooltip />
                                                <Line type="monotone" dataKey="submissions" stroke="#171717" strokeWidth={2} activeDot={{ r: 8 }} />
                                            </LineChart>
                                        </ResponsiveContainer>
                                    </div>
                                </CardContent>
                            </Card>
                            <Card className="col-span-3 border border-neutral-200">
                                <CardHeader>
                                    ...
                                    <div className="space-y-8">
                                        {[1, 2, 3, 4, 5].map((i) => (
                                            <div className="flex items-center" key={i}>
                                                ...
                                                <div className="ml-auto font-medium text-neutral-600 text-sm">Completed</div>
                                            </div>
                                        ))}
                                    </div>
                                </CardContent>
                                    ...
                                    <TableBody>
                                        {profiles.map((profile) => (
                                            <TableRow key={profile.id}>
                                                <TableCell className="font-mono text-xs text-neutral-500">{profile.id.slice(0, 8)}...</TableCell>
                                                ...
                                                <TableCell><Badge variant="secondary" className="bg-neutral-100 text-neutral-700">Active</Badge></TableCell>
                                                ...
                                                <TableCell className="text-right text-neutral-500">{stats[profile.id]?.lastActive}</TableCell>
                                            </TableRow>
                                        ))}
                                    </TableBody>
                                </Table>
