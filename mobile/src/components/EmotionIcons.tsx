...
export const StressLevel1 = ({ size = 40 }: EmotionIconProps) => (
    <Svg width={size} height={size} viewBox="0 0 40 40" fill="none">
        ...
        <Circle cx="14" cy="16" r="2.5" fill="#749F82" />
        <Circle cx="26" cy="16" r="2.5" fill="#749F82" />
        <Path d="M12 25 Q20 32, 28 25" stroke="#749F82" strokeWidth="2.5" strokeLinecap="round" fill="none" />
    </Svg>
);
...
export const StressLevel2 = ({ size = 40 }: EmotionIconProps) => (
    <Svg width={size} height={size} viewBox="0 0 40 40" fill="none">
        ...
        <Path d="M13 25 Q20 29, 27 25" stroke="#94BCA1" strokeWidth="2.5" strokeLinecap="round" fill="none" />
    </Svg>
);
...
export const RelaxationLevel4 = ({ size = 40 }: EmotionIconProps) => (
    <Svg width={size} height={size} viewBox="0 0 40 40" fill="none">
        <Circle cx="20" cy="20" r="18" fill="#E6F4EA" stroke="#94BCA1" strokeWidth="2" />
        <Path d="M11 16 Q14 15, 17 16" stroke="#94BCA1" strokeWidth="2" strokeLinecap="round" fill="none" />
        <Path d="M23 16 Q26 15, 29 16" stroke="#94BCA1" strokeWidth="2" strokeLinecap="round" fill="none" />
        <Path d="M13 24 Q20 28, 27 24" stroke="#94BCA1" strokeWidth="2.5" strokeLinecap="round" fill="none" />
    </Svg>
);
...
export const RelaxationLevel5 = ({ size = 40 }: EmotionIconProps) => (
    <Svg width={size} height={size} viewBox="0 0 40 40" fill="none">
        <Circle cx="20" cy="20" r="18" fill="#E6F4EA" stroke="#749F82" strokeWidth="2" />
        <Path d="M11 16 Q14 14, 17 16" stroke="#749F82" strokeWidth="2" strokeLinecap="round" fill="none" />
        <Path d="M23 16 Q26 14, 29 16" stroke="#749F82" strokeWidth="2" strokeLinecap="round" fill="none" />
        <Path d="M13 24 Q20 30, 27 24" stroke="#749F82" strokeWidth="2.5" strokeLinecap="round" fill="none" />
        <Path d="M6 20 Q8 18, 6 16" stroke="#749F82" strokeWidth="1" strokeLinecap="round" fill="none" opacity="0.5" />
        <Path d="M34 20 Q32 18, 34 16" stroke="#749F82" strokeWidth="1" strokeLinecap="round" fill="none" opacity="0.5" />
    </Svg>
);
